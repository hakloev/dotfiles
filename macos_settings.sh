sed upon .macos from https://mths.be/macos
...
read -r -p "Enter your preferred hostname: [hostname/N] " hostname
echo
case $hostname in
    [nN])
        echo "Will not set hostname"
		;;
	*)
...
###########
# TRACKPAD, MOUSE, KEYBOARD, BT, INPUT
###########
...
defaults write NSGlobalDomain AppleLocale -string "en_GB@currency=NOK"
...
echo "Done. You really should restart now, in order for all updates to take effect"
